      ...
      <div className="min-h-screen bg-gradient-to-b from-brand-50 to-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-16 text-center">
          <div className="w-full max-w-sm animate-fade-up">
            ...
            <p className="text-sm font-medium text-gray-500 mb-2 leading-relaxed">
              We sent a verification link to <strong>{email}</strong>.
            </p>
            <p className="text-sm font-medium text-gray-500 mb-8 leading-relaxed">
              Click the link in the email to verify your account, then sign in.
            </p>
            <div className="mb-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-xs text-amber-800 text-left leading-relaxed">
            ...
            <Link href="/login"
              className="w-full inline-flex items-center justify-center gap-2 bg-brand-900 text-white font-bold py-3.5 rounded-xl hover:bg-brand-800 transition-colors text-[15px] shadow-lg shadow-brand-200">
              <CheckCircle className="w-4.5 h-4.5" /> Go to sign in
            </Link>
            <p className="text-xs font-semibold text-gray-400 mt-6">
              Didn't receive it? Check your spam folder or{' '}
              <button onClick={() => sendVerificationEmail()} className="text-brand-600 hover:text-brand-800 underline transition-colors">resend</button>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-sm animate-fade-up">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 mb-1.5">Create an account</h1>
            <p className="text-sm font-medium text-gray-500">Free · Takes 30 seconds.</p>
          </div>
          ...
          <p className="text-center text-sm font-medium text-gray-500 mt-8">
            ...
            <Link href="/login" className="text-brand-700 hover:text-brand-900 font-bold">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
