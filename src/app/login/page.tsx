      ...
      <div className="flex-1 flex items-center justify-center px-5 py-16">
        <div className="w-full max-w-sm animate-fade-up">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-gray-500">Sign in to continue to Sprout.</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/forgot-password" className="text-xs text-blue-700 hover:text-blue-900 font-semibold">Forgot?</Link>
                </div>
                <div className="relative">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/signup" className="text-blue-700 hover:text-blue-900 font-bold">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
